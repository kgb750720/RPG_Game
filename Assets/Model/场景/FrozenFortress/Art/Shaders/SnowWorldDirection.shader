...
///////// Gloss:
                ...
                float node_3688 = clamp(((clamp(dot(normalDirection,float3(0,1,0)),0,1)*3.0+-1.0)*_SnowAmount),0,1);
...
/// Final Color:
                outDiffuse = half4( diffuseColor, node_2523 );
                outSpecSmoothness = half4( specularColor, gloss );
                outNormal = half4( normalDirection * 0.5 + 0.5, 1 );
                outEmission = half4(0,0,0,1);
                outEmission.rgb += indirectSpecular * node_2523;
